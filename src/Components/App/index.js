...
import KoreaThankYou from "../KoreaThankYou/index"
        ...
        <BrowserRouter>
          <Switch>
            ...
            <Route
              exact
              path="/leaderboard/:id"
              component={contained("leaderboard")}
            />
            <Route
              exact
              path="/leaderboards"
              component={contained("leaderboards")}
            />
            ...
            <Route
              exact
              path="/setup-game"
              component={contained("gameSetup")}
            />
            <Route
              exact
              path="/start-free-trial"
              component={contained("infoForm")}
            />
            <Route exact path="/welcome" component={contained("welcome")} />
            <Route exact path="/korea-thank-you" component={KoreaThankYou} />
  ...
  render() {
    ...
    return (
      <OuterFrame>
        ...
        <InnerFrame>
          <ComponentFrame>{component()}</ComponentFrame>
          <Footer />
        </InnerFrame>
      </OuterFrame>
    )
